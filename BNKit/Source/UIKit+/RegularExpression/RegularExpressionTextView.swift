//
//  RegularExpressionTextView.swift
//  WorkMap
//
...
open class RegularExpressionTextView: PlaceholderTextView {
    ...
    override open var text: String? {
        didSet {
            textStorage.delegate?.textStorage?(textStorage, didProcessEditing: .editedCharacters, range: NSRange(), changeInLength: 1)
       }
    }
